...
public class EinkaufZeichnungsbedarfService {
    private static final long VORLAEUFIGE_ANLAGENREFERENZ = Long.MAX_VALUE;
    ...
    public EinkaufBedarfDto.Response anlegen(EinkaufBedarfDto.Create eingabe, MultipartFile datei,
        ...
        PositionSnapshot zwischenstand = mitAnlagen(position, List.of(VORLAEUFIGE_ANLAGENREFERENZ));
