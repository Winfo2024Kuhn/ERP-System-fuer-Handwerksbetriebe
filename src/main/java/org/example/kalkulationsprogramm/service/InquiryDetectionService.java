...
public class InquiryDetectionService {
    ...
    private static final List<InquiryKeyword> STRONG_INQUIRY_KEYWORDS = List.of(
        ...
        new InquiryKeyword("bitte um anfrage", 40),
        new InquiryKeyword("anfrage erstellen", 35),
        ...
        new InquiryKeyword("bitte um ein anfrage", 40),
        new InquiryKeyword("unverbindliches anfrage", 35),
