...
public class EinkaufBestellung {
 ...
 public void addRevision(BestellungRevision r){revisionen.add(r);} public Long getId(){return id;} public Long getVersion(){return version;} public void setVersion(Long v){version=v;} public String getNummer(){return nummer;} public Long getLieferantId(){return lieferantId;} public Long getAngebotsversionId(){return angebotsversionId;} public Long getAnfrageRevisionId(){return anfrageRevisionId;} public Snapshot getEmpfaenger(){return empfaenger;} public BestellungStatus getStatus(){return status;} public void setStatus(BestellungStatus s){status=s;} public LieferantenBestellstatus getLieferantenStatus(){return lieferantenStatus;} public void setLieferantenStatus(LieferantenBestellstatus s){lieferantenStatus=s;} public UUID getIdempotenzKey(){return idempotenzKey;} public String getPayloadHash(){return payloadHash;} public Long getAngelegtVon(){return angelegtVon;} public List<BestellungRevision> getRevisionen(){return List.copyOf(revisionen);}
}
