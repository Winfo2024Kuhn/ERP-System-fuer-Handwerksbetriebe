...
public class LieferantGeschaeftsdokument {
    ...
    private Boolean bereitsGezahlt = false; // Von KI erkannt (z. B. Vorauskasse oder Lastschrift)

    @Column(length = 50)
    private String zahlungsart; // Z. B. VORAUSKASSE, SEPA_LASTSCHRIFT, KREDITKARTE
