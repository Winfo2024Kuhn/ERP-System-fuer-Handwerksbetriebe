...
public final class EinkaufBestellungDto {
 ...
 public record Revision(Long id,int nummer,long version,Map<String,Object> snapshot,String sha256,Long versandId,boolean verworfen,List<Position> positionen,java.time.Instant angenommenAm,Map<String,Object> externerNachweis) {
 public Revision { snapshot=Map.copyOf(snapshot); positionen=List.copyOf(positionen); externerNachweis=externerNachweis==null?Map.of():Map.copyOf(externerNachweis); }
 public Revision(Long id,int nummer,long version,Map<String,Object> snapshot,String sha256,Long versandId,boolean verworfen,List<Position> positionen){this(id,nummer,version,snapshot,sha256,versandId,verworfen,positionen,null,Map.of());}
 }
