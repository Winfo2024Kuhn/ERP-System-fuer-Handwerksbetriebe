...
public final class EinkaufBestellungDto {
 ...
 public record Revision(Long id,int nummer,long version,Map<String,Object> snapshot,String sha256,Long versandId,List<Position> positionen) { public Revision { snapshot=Map.copyOf(snapshot); positionen=List.copyOf(positionen); } }
