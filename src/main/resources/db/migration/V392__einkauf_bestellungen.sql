CREATE TABLE IF NOT EXISTS einkauf_bestellung (
 ...
 idempotenz_key CHAR(36) NOT NULL, payload_hash CHAR(64) NOT NULL, angelegt_von BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS einkauf_bestellung_revision (
 ...
 snapshot JSON NOT NULL, sha256 CHAR(64) NOT NULL, geaendert_von BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS einkauf_bestellung_position (
 ...
 menge DECIMAL(19,6) NOT NULL, netto_einzelpreis DECIMAL(19,6) NULL, waehrung CHAR(3) NOT NULL,
