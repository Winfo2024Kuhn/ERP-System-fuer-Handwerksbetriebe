# 📚 Dokumentation – Handwerkerprogramm

Willkommen in der Dokumentation des Handwerkerprogramms. Hier findest du alle technischen und fachlichen Dokumente zum System.
...
| Dokument | Inhalt |
|----------|--------|
| [BUSINESS_CASES.md](BUSINESS_CASES.md) | Geschäftsnutzen aller Module (Kalkulation, Controlling, KI, E-Mail, Zeiterfassung) |
| [GOBD_COMPLIANCE.md](GOBD_COMPLIANCE.md) | GoBD-Konformität: Unveränderbarkeit, Löschverbot, Audit-Trail, Nummerierung |
| [RECHNUNGSWESEN.md](RECHNUNGSWESEN.md) | Kompletter Rechnungsprozess von Erstellung bis Versand |
...
Im Verzeichnis [`Dokumentation/`](Dokumentation/) befinden sich draw.io-Diagramme:

| Diagramm | Beschreibung |
|----------|--------------|
| 01_Architektur_Uebersicht.drawio | System-Gesamtarchitektur |
| 02_Dokumenten_Lifecycle.drawio | Dokumenten-Lebenszyklus |
| 03_Email_System.drawio | E-Mail-System-Architektur |
| 04_Zeiterfassung_Workflow.drawio | Zeiterfassungs-Ablauf |
| 05_Rechnungswesen.drawio | Rechnungsprozess |
| 06_Datenmodell_Kernentitaeten.drawio | Datenmodell der Kern-Entities |
| GlobalEmailWhatcher.drawio | Globaler E-Mail-Watcher |

> 💡 draw.io-Dateien können im Browser unter [app.diagrams.net](https://app.diagrams.net) geöffnet werden.
