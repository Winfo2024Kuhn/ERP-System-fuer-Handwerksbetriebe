...
- Gespeicherte Genauigkeit erhalten: zulässige Nachkommastellen aus dem fachlichen API-/Datenbankvertrag ableiten, nicht aus einem früheren Browser-`step`. Fehlende API-Zahlen als leeren Entwurf und in Übersichten als fehlend darstellen. Kein Absturz, erfundener Nullwert oder Übernehmen eines alten Entwurfs beim Datensatzwechsel.
