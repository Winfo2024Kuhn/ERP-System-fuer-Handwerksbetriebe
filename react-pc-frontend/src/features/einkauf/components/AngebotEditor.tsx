...
export function AngebotEditor({ beteiligungId, anfrageRevisionId, positionen, angebotId, initial, onSaved }: Props) {
  ...
  return <section className="space-y-4 rounded-lg border border-slate-200 bg-white p-4"><header><h2 className="font-semibold">Angebot manuell erfassen</h2><p className="text-sm text-slate-600">Eingaben bleiben bearbeitbar, auch wenn eine automatische Analyse nicht verfügbar ist.</p></header>
