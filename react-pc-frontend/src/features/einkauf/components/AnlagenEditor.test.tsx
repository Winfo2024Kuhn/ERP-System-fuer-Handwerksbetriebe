...
it('verlangt für ein Zeichnungsteil mindestens eine freigegebene Zeichnungsanlage', () => {
  ...
  render(<AnlagenEditor anlagen={[{ id: 8, dateiId: 18, bedarfId: 6, revision: 'A', dateiname: 'Plan A.pdf', mimeTyp: 'application/pdf', byteAnzahl: 4096, sha256: 'hash', freigegeben: false, versendet: false, hochgeladenAm: '2026-09-24T08:00:00Z' }]} ausgewaehlt={[]} onChange={onChange} zeichnungsteil />);
