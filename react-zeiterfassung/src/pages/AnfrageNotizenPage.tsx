...
export default function AnfrageNotizenPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const url = editingNotiz
                ? `/api/anfragen/${anfrageId}/notizen/${editingNotiz.id}`
                : `/api/anfragen/${anfrageId}/notizen`
    ...
    const handleImageUpload = async (notizId: number, file: File) => {
        ...
        try {
            ...
            const res = await fetch(`/api/anfragen/${anfrageId}/notizen/${notizId}/bilder?token=${token}`, {
                method: 'POST',
                body: formData
            })
            if (res.ok) {
